...
public class Util {
	...
	public static void imprimirAST(NodoBase raiz) {
		...
		while (raiz != null) {
			...
			} else if (raiz instanceof NodoOperacion || raiz instanceof NodoValor
					|| raiz instanceof NodoIdentificador) {
				imprimirNodo(raiz);
			} else if (raiz instanceof NodoDeclaracion) {
				System.out.println("Declaracion de: " + ((NodoDeclaracion) raiz).getId() + " Tamano: "
						+ ((NodoDeclaracion) raiz).getTamano());
			} else {
	...
	static void imprimirNodo(NodoBase raiz) {
		if (raiz instanceof NodoRepeat || raiz instanceof NodoLeer || raiz instanceof NodoEscribir) {
		...
		if (raiz instanceof NodoOperacion) {
			...
			NodoOperacion v = (NodoOperacion) raiz;
			tipoVar r = v.getRetorna();
			if (sel == tipoOp.menor) {
				System.out.println("<");
			}
